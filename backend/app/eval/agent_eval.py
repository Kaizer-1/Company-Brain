...
async def evaluate_question(
    ...
    *,
    ...
    if expected_route in {"kq1", "kq2", "kq3", "kq4"}:
...
def render_agent_report(report: AgentEvalReport) -> str:
    ...
    lines: list[str] = []
    lines.append("# Phase 4A — Agent Eval Results\n")
    ...
    lines.append("|--------|-------|--------|")
    lines.append(f"| Route accuracy | {report.route_accuracy:.3f} | ≥ 0.85 |")
    lines.append(f"| Citation overlap (mean Jaccard, KQ Qs) | {report.citation_overlap_mean:.3f} | ≥ 0.50 |")
